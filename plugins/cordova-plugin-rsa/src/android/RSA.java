    ...
    public boolean execute(String action, JSONArray args,CallbackContext callbackContext) throws JSONException {
        ...
        if("encrypt".equalsIgnoreCase(action)){
            try {
                ...
                fname = Base64.encodeToString(RSACoder.encryptByPublicKey(RSACoder.encryptMD5WithSalt(fname.getBytes(),RSACoder.KEY_SALT),RSACoder.PUBLIC_KEY_DATA),Base64.DEFAULT);
